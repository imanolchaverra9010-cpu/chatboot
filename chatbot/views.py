        ...
        if message_type == 'text':
            ...
            if documento:
                ...
                if info_votacion:
                    ...
                    response_text = (
                        "No encontr� informaci�n de votaci�n para ese documento.\n"
                        "Verifica el n�mero e int�ntalo de nuevo."
                    )
                intent_detectado = 'consulta_puesto_votacion'
            elif _es_consulta_elecciones(content):
                response_text = (
                    "Para consultarte el puesto de votaci�n, env�ame tu n�mero de documento "
